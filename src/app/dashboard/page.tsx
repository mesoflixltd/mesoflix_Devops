    ...
    <div className="min-h-screen bg-[#020617] text-white flex font-inter">
      ...
      <aside className="w-20 lg:w-64 border-r border-white/[0.05] bg-[#020617]/50 backdrop-blur-xl flex flex-col items-center lg:items-start p-6">
        ...
        <div className="pt-8 border-t border-white/5 w-full mt-auto">
          <div className="w-10 h-10 rounded-full bg-white/5 mx-auto lg:mx-0" />
        </div>
      </aside>
        ...
        <div className="max-w-5xl mx-auto space-y-12">
          ...
          <header className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <h1 className="text-3xl font-black tracking-tight">Project Command Center</h1>
            </div>
            <div className="flex items-center gap-4">
              <div className="px-4 py-2 bg-white/[0.03] border border-white/[0.08] rounded-lg text-xs font-bold tracking-widest text-foreground/40">
                PROD-01-LIVE
              </div>
